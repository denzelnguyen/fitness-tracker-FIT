...
df['participant'] = df['participant'].str.lstrip("\\")
df['category'] =  df['category'].str.replace("_MetaWear_2019", "") 
...
dataset.loc[dataset["gyr_z_outlier"], "gyr_z"] = np.nan #if outlier -> gyr_z = NaN
